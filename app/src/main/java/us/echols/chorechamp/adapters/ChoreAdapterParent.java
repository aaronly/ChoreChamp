...
public class ChoreAdapterParent extends RecyclerView.Adapter<ChoreAdapterParent.myViewHolder> implements ChoreAdapter {
     ...
     */
    public ChoreAdapterParent(Context context, List<Chore> chores) {
        this.chores = chores;
    ...
    public void onBindViewHolder(myViewHolder viewHolder, int position) {
        ...
        nameTextView.setText(chore.getName() + " (" + chore.getChildName() + ")");
